    ...
    <template v-if="statue">
      ...
      <div class="excellentCurriculumDesignP-class">
        ...
        <my-detail
          ...
          :current="i"
          :list="idList"
          :from="'/gallery/excellentCurriculumDesignP/' + $route.params.id"
        />
        <my-paging
...
export default {
  ...
  methods: {
    ...
    goBack() {
      this.statue = false;
      this.$router.push(`/gallery/excellentCurriculumDesignP`);
    },
    toDesign(data) {
      this.$router.push(`/gallery/excellentCurriculumDesignP/${data.id}`);
